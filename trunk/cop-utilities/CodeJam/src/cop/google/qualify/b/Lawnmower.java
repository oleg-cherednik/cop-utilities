...
public class Lawnmower {
	...
	public static void main(String[] args) {
		try {
			new Lawnmower().run("test");
			// new TicTacToeTomek().run("small");
			// new Lawnmower().run("large");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	private static int[][] readCase(BufferedReader in) throws IOException {
	...
	private void buildSet(int[][] board) throws Exception {
		boolean valid = true;
