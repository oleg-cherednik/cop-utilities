...
import static cop.utils.JavaBeanUtils.getSetterMethod;
...
public final class ReflectionUtils {
	...
	public static boolean isString(Class<?> type) {
		return isNotNull(type) && type.isAssignableFrom(String.class);
	}
	...
	public static boolean isIntegerWrapper(Class<?> type) {
		return isNotNull(type) && type.isAssignableFrom(Integer.class);
	}
	...
	public static boolean isByteWrapper(Class<?> type) {
		return isNotNull(type) && type.isAssignableFrom(Byte.class);
	}
	...
	public static boolean isShortWrapper(Class<?> type) {
		return isNotNull(type) && type.isAssignableFrom(Short.class);
	}
	...
	public static boolean isLongWrapper(Class<?> type) {
		return isNotNull(type) && type.isAssignableFrom(Long.class);
	}
	...
	public static boolean isFloatWrapper(Class<?> type) {
		return isNotNull(type) && type.isAssignableFrom(Float.class);
	}
	...
	public static boolean isDoubleWrapper(Class<?> type) {
		return isNotNull(type) && type.isAssignableFrom(Double.class);
	}
